...
MySQL - 8.0.21 : Database - ics_master_db_v1_CDW_{month}
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`ics_master_db_v1_CDW_{month}` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;

USE `ics_master_db_v1_CDW_{month}`;
...
CREATE TABLE `category_link_brand_sep` (
  `id` int NOT NULL AUTO_INCREMENT,
  `vendor_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `vendor_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `product_urls` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
CREATE TABLE `category_sitemap_final` (
  `id` int NOT NULL AUTO_INCREMENT,
  `vendor_id` varchar(300) DEFAULT NULL,
  `vendor_name` varchar(765) DEFAULT NULL,
  `product_urls` varchar(765) DEFAULT NULL,
  `meta_data` json DEFAULT NULL,
...
open('E:\DATA\gaurav\Projects\cdw\cdw.sql', 'w').write(query)
