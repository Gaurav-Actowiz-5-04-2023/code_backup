...
from ics_v1 import validation_function
...
OUTPUT_LOCATION = "E:/DATA/gaurav/outputfile/"
...
validation = validation_function.data_validations(product_df)

if validation:
    print('File validated completed.....')
