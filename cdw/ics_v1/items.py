...
class IcsV1SiteMapLinksItemfinal(scrapy.Item):
    # USE THIS ITEM TO STORE THE LINKS COLLECTED USING THE SITEMAP
...
class IcsV1SiteMapLinksItem1(scrapy.Item):
    # USE THIS ITEM TO STORE THE LINKS COLLECTED USING THE SITEMAP
...
class IcsV1SiteMapLinksItem2(scrapy.Item):
    # USE THIS ITEM TO STORE THE LINKS COLLECTED USING THE SITEMAP
...
class IcsV1SiteMapLinksItem3(scrapy.Item):
    # USE THIS ITEM TO STORE THE LINKS COLLECTED USING THE SITEMAP
